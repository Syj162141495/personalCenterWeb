...
<script lang="ts" setup name="ViewsInformationBasicInformationForm">
  ...
  import { BasicInformation, basicInformationSave, basicInformationForm } from '/@/api/information/basicInformation';
  ...
  const inputFormSchemas: FormSchema[] = [
    {
      ...
      rules: [{ required: true }, { pattern: /^[\u4e00-\u9fa5]{2,30}$/, message: t('请输入真实姓名') }],
    },
    {
      label: t('性别'),
      field: 'sex',
    ...
    },
    {
      ...
      rules: [{ pattern: /(^0[1-9]{1}\d{8,10}$)|(^1[3,4,5,6,7,8,9]\d{9}$)/g, message: t('请输入固话或手机号码') }],
    },
    {
      label: t('民族'),
      field: 'ethnic',
